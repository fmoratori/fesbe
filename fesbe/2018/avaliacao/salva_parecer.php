...
$mail->Subject = 'Avaliacao Trabalho '.utf8_encode($row_evento['nome_evento']);
...
$mensagemHTML = "O trabalho <b>".$row56['titulo']."</b> Recebeu o seguinte parecer:<br /><br />".$parecer2. "<br />Acesse sua &aacute;rea restrita e realize as altera&ccedil;&otilde;es necess&aacute;rias at&acute; o dia 12 de Junho. ".$quebra_linha."<br /><br />Atenciosamente,<br />Comiss&atilde;o Organizadora <br />".utf8_encode($row_evento['nome_evento']);
