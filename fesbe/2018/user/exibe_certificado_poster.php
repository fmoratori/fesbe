...
$texto = "Certificamos que o trabalho ".$titulo_exibe." foi apresentado na forma de painel durante a ".$row_evento['nome_evento'].", realizado de ".$inicio." a ".$fim." na cidade de ".$row_evento['local'].".";
