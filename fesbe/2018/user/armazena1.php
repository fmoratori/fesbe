...
//    $insertCmd = mysql_query(INSERT INTO `tb_trabalhos` (`id`, `usuario_id`, `status`, `area_id`, `titulo`, `introducao`) VALUES (NULL, '$id_usuario', '1', '$area', '$titulo', '$resumo');
    $sql_insere_trabalho="INSERT INTO `tb_trabalhos` (`id`, `usuario_id`, `status`, `area_id`, `titulo`, `introducao`, `objetivos`, `metodos`, `resultados`, `conclusao`, `apoio`, `comite`, `premio`) VALUES ($id_trabalho, '$id_usuario', '1', '$area', '$titulo', '$introducao', '$objetivos', '$metodos', '$resultados', '$conclusao', '$apoio', '$comite', '6')";
    ...
    $sql_insere_trabalho="UPDATE `fmsys_eventos`.`tb_trabalhos` SET `area_id` = '$area',`titulo` = '$titulo', `introducao` = '$introducao', `objetivos`= '$objetivos', `metodos`= '$metodos', `resultados`='$resultados', `conclusao`='$conclusao', `apoio`= '$apoio', `comite`='$comite', `msg_avaliador`='$justifique' WHERE `tb_trabalhos`.`id` = $id_trabalho";	
    $res_insere_trabalhos = mysqlexecuta($id,$sql_insere_trabalho);
    }
}
if($caracteres>3550){
     echo "<meta http-equiv='refresh' content=0;url='http://fmsys.com.br/fmsys/fesbe/2/user/principal.php?pg=trabalhos.php&id_trabalho=$id_trabalho&caracteres=$caracteres'>";
    break;
}

?>
<meta http-equiv="refresh" content="0; url=./principal.php?pg=pre_comite.php&id_trabalho=<? echo $id_trabalho; ?>">
