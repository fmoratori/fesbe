...
$autenticacao = sha1($titulo_exibe.'mencao');
    ...
    $texto = "Certificamos que o trabalho ".$titulo_exibe." foi contemplado com MENÇÃO HONROSA durante a ".$row_evento['nome_evento'].", realizado de ".$inicio." a ".$fim." na cidade de ".$row_evento['local'].".";
