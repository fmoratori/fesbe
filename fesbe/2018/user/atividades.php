...
<?
    echo "<div class='ls-alert-danger'><b>INSCRI&Ccedil;&Otilde;ES EM ATIVIDADES ENCERRADAS</b></div>";    
...
if($atividade=='' || $atividade2==''){
    ...
    $sql_insere_atividade_inscrito = "UPDATE `fmsys_eventos`.`tb_usuario` SET `inscricao_obs`='$atividade', `inscricao_obs2`='$atividade2' WHERE `id`=$id_usuario";
