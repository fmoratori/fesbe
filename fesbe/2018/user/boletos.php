...
$preference_data = array(
	...
	"back_urls" => array(
		...
		"success" => "http://fmsys.com.br/fmsys/fesbe/2/user/principal.php?pg=get_boletos.php",

		"failure" => "http://fmsys.com.br/fmsys/fesbe/2/user/principal.php?pg=get_boletos.php",

		"pending" => "http://fmsys.com.br/fmsys/fesbe/2/user/principal.php?pg=get_boletos.php"
...
//		"excluded_payment_methods" => array(
	...
	"notification_url" => "http://www.fmsys.com.br/fmsys/fesbe/2/user/retorno2.php?id=$id_bol",
