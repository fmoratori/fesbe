...
while($row_trabalhos = mysql_fetch_array($res_trabalhos)){
    ...
    Número de Apresentação: <b><? echo $area.".".$row_trabalhos['painel']; ?></b><br />
...
<?            
    ...
    $parecer = str_replace('---------', '<br />',$row_trabalhos['parecer']);
    echo $parecer."<br />";
    echo "A Correção deverá ser efetuada até o dia <b>22 de junho de 2017</b>, para que seja reavaliado, caso contrário será cancelado.";
     ?>
     </div>
<?            
        }
