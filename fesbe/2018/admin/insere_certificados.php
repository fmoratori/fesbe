...
while($x<$total){
    ...
    $sql_insere_certificados="INSERT INTO `tb_certificados` (`id`, `usuario_id`, `id_atividade`, `carga_horaria`, `validacao`) VALUES (NULL, '$id_usuario', '$id_atividade', '$carga_horaria', '$validacao')";
