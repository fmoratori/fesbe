...
$sql_insere_boleto="UPDATE `fmsys_eventos`.`tb_boleto` SET `referente`='$referente',`valor`='$valor',`vencimento`='$vencimento',`situacao`='$situacao',`observacao`='$observacao' WHERE `id`='$id_boleto';";
