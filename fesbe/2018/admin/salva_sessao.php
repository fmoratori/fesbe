...
$sql_salva_sessao = "INSERT INTO `fmsys_eventos`.`tb_sessao` SET `nome`='$nome', `sigla`='$sigla_sessao', `data_inicio`='$data_inicio', `data_fim`='$data_fim', `hora_inicio`='$hora_inicio', `hora_fim`='$hora_fim';";
