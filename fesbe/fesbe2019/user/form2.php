...
<fieldset>
            ...
            <input type="text" name="departamento" id="departamento" size="25" required="required" value="<? echo $row_cpf['departamento']; ?>" />
            </label>

            <label class="ls-label col-md-3">
            <b class="ls-label-text">Instituto</b>
            <input type="text" name="instituto" id="instituto" size="25" required="required" value="<? echo $row_cpf['instituto']; ?>" />
            </label>

            <label class="ls-label col-md-4">
            <b class="ls-label-text">Instituição</b>
            <input type="text" name="instituicao" id="instituicao" size="25" required="required" value="<? echo $row_cpf['instituicao']; ?>" />
            </label>
...
<fieldset>
<label class="ls-label col-md-3">
    <b class="ls-label-text">ID (Only Numbers)</b>
    <input type="text" name="cpf" class="" placeholder="" required="required" value="<? echo $cpf; ?>" > 
  </label>
</fieldset>
<fieldset>
<label class="ls-label col-md-4">
...
<label class="ls-label col-md-2">
    ...
    <input type="text" name="telefone" class="ls-mask-phone12_with_ddd" placeholder="(00)0000-000000" value="<? echo $row_cpf['telefone']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text">Celphone</b>
    <input type="text" name="celular" class="ls-mask-phone12_with_ddd" placeholder="(00)90000-00000"  value="<? echo $row_cpf['celular']; ?>" > 
  </label>
</fieldset>
<fieldset>
    <label class="ls-label col-md-3">
...
<fieldset>
            <label class="ls-label col-md-2">
            <b class="ls-label-text">Zip Code</b>
            <input type="text" name="cep" id="cep" class="ls-mask" placeholder="0000" maxlength="8" required="required" value="<? echo $row_cpf['cep']; ?>" />
            </label>
</fieldset>
<fieldset>
            <label class="ls-label col-md-5">
            ...
            <label class="ls-label col-md-2">
            <b class="ls-label-text">Country</b>
            <input type="text" name="estado" id="estado" size="2" value="<? echo $row_cpf['estado']; ?>" />
            </label>
</fieldset>
...
<fieldset>
    ...
    <label class="ls-label col-md-8 col-sm-8">
      <b class="ls-label-text">Scientific Society</b>
      <div class="ls-custom-select">
        <select name="sociedade" class="ls-select">
<?
include 'mysqlconecta.php';
