...
$autenticacao = sha1($titulo_exibe);
	...
	$texto = "Certificamos que o trabalho ".$titulo_exibe." foi apresentado na forma de painel durante a ".$row_evento['nome_evento'].", realizado de 09 a 13 de setembro de 2019"." no  ".$row_evento['local'].".";
