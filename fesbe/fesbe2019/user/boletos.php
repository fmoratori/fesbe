<?
$sql_boleto = "SELECT * FROM tb_boleto WHERE user_id = $id_usuario ORDER BY id";
...
$valor = $row_boleto['valor'];
if($row_boleto['valor']=='0'){
    $valor='1';
    }
...
$resto = $row_boleto['id']%5;

//if(($resto==0 && $row_boleto['valor']<950 && $row_boleto['categoria']!=9)|| 1==0){
if(1==2){    
...
$referente = $row_boleto['referente'];
if($row_boleto['categoria']==5){
    $referente = "POS GRAD Socio";
}
if($row_boleto['categoria']==7){
    $referente = "POS DOC Socio";
}

$data['itemDescription1'] = $referente;
...
?>
      ...
      <td><!--a href='<? echo $link; ?>'target='_blank'> <b>Clique Aqui Para Realizar o Pagamento</b></a-->PAGAMENTO SOMENTE NA SECRETARIA DO EVENTO
</td>
