...
$texto = "I am pleased to inform you that your abstract ".utf8_encode($titulo).", autores ".utf8_encode($autores).", has been accepted for poster presentation at the XXXIV FeSBE Annual Metting in Campos do Jordão to be held September 9-13, 2019";
$texto2 = "Abstract ID number: ".$area.".".$row66['painel']."\n".
"First author: ".$primeiro_autor."\n".
"Poster Session Title: ".$nome_area."\n".
"Day of presentation: ".$dia_apresenta."\n".
"Poster presentation time: 16:00 - 18:00 
...
$texto3 = " -	Poster should be in English.\n -	The dimensions of the poster should not exceed 110 x 96 cm (height x width).\n -	Allocate the top of the poster for the title, authors and affiliations. Title and authors as stated on the submitted abstract.\n -	Poster title should be readable by viewers 3 m away (Arial 60 or bigger). The text, illustration, etc. should be readable from 2 m.\n";
$texto4 = "All abstract presenters must register for the meeting. Become a member of one of FeSBE affiliated societies to receive best rates.\nFor information regarding the conference please visit the conference website. 
\nRegards,
\nFeSBE secretariat";
$evento = $row['sigla'];
...
$pdf->Ln(5);
$pdf->MultiCell(0,15, utf8_decode("Dear ").$inscrito.",",0,'J');
$pdf->Ln(10);
$pdf->MultiCell(0,15, utf8_decode("$texto"),0,'J');
$pdf->SetFont('arial','U',10);
$pdf->Ln(10);
$pdf->MultiCell(0,15, utf8_decode("POSTER PRESENTATION INFORMATION\n"),0,'J');
$pdf->SetFont('arial','',10);
$pdf->Ln(5);
$pdf->MultiCell(0,15, utf8_decode("$texto2"),0,'J');
$pdf->SetFont('arial','U',10);
$pdf->Ln(10);
$pdf->MultiCell(0,15, utf8_decode("INSTRUCTIONS FOR POSTER PREPARATION\n"),0,'J');
$pdf->SetFont('arial','',10);
$pdf->Ln(5);
$pdf->MultiCell(0,15, utf8_decode("$texto3"),0,'J');
$pdf->Ln(10);
$pdf->SetFont('arial','U',10);
$pdf->MultiCell(0,15, utf8_decode("REGISTRATION\n"),0,'J');
$pdf->SetFont('arial','',10);
$pdf->Ln(5);
$pdf->MultiCell(0,15, utf8_decode("$texto4"),0,'J');
...
$pdf->Ln(20);
//$pdf->MultiCell(0,25, utf8_decode("Data e horário de apresentação: "),0,'J');
...
$pdf->Image("../imagens/assinatura_davel.jpg",270,670,72,36);
$pdf->SetY(710);
...
$pdf->Output("$autentic.pdf","I");
    ...
    echo 'Carta de Aceite Indisponivel. Seu Trabalho ainda n&atilde;o foi aprovado.';
}
?>
<script>
window.close();
