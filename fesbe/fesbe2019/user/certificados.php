...
$cpf_usuario = $row_usuario['cpf'];
    ...
    $sql_certificados_presenca2 = "SELECT * FROM tb_usuario WHERE cpf=$cpf_usuario";
    $res_certificados_presenca2 = mysqlexecuta($id,$sql_certificados_presenca2);
    $row_certificados_presenca2=mysql_fetch_array($res_certificados_presenca2);
/**
if($row_certificados_presenca2['pesquisa']==''){
 header('Location: ./principal.php?pg=pesquisa.php');
 exit();   
}
**/
...
if($row_certificados_poster['area_id'] < 26){
?>    <tr>
...
?>
    <tr>
      <td><a href="exibe_certificado_jovem.php?id_certificado_poster=<? echo $id_certificado_poster; ?>" target="_blank" title=""><? echo $row_certificados_poster['titulo']; ?></a></td>
      <td><a href="exibe_certificado_jovem.php?id_certificado_poster=<? echo $id_certificado_poster; ?>" target="_blank" title=""><b>Certificado FeSBE Jovem</b></a></td>
    </tr>
<?
}
...
$id_usuario_certificado = $row_usuario['num_inscricao'];
/**
...
**/
    ...
    $sql_certificados = "SELECT * FROM tb_certificados WHERE usuario_id=$id_usuario_certificado";
