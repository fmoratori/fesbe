...
$pgto = $_POST['pgto'];
    ...
    echo     "<a href='#' class='ls-collapse-header'><p><b>".$row_consulta_inscritos['data']." - ".$row_consulta_inscritos['sala']." - ".$row_consulta_inscritos['atividade']."</b></p></a>";
    echo "<div class='ls-collapse-body' id='$id1'>";
