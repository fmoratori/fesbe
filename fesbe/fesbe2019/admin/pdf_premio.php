...
$area_id = $row_area['id'];
    ...
    $sql_trabalhos = "SELECT * FROM tb_trabalhos WHERE area_id=$area_id AND status=4 AND `premio`=2 ORDER BY painel ASC";
...
$usuario_id = $row_trabalhos['usuario_id'];
$hora = date("d-m-Y");
...
$sql_usuario = "SELECT * FROM tb_usuario WHERE id=$usuario_id";
...
$pdf->MultiCell(0,18,$row_usuario['nome']." - ".$row_usuario['email'],0,'C');	
$pdf->SetFont('arial','B',12);
$pdf->MultiCell(0,18,"Introdução:",0,'J');
$pdf->SetFont('arial','',12);
$pdf->MultiCell(0,18, utf8_encode("$introducao"),0,'J');
$pdf->SetFont('arial','B',12);
//$pdf->Ln(8);
$pdf->MultiCell(0,18, utf8_encode("Objetivos:"),0,'J');
$pdf->SetFont('arial','',12);
$pdf->MultiCell(0,18, utf8_encode("$objetivos"),0,'J');
//$pdf->Ln(8);
$pdf->SetFont('arial','B',12);
$pdf->MultiCell(0,18, "Métodos:",0,'J');
$pdf->SetFont('arial','',12);
$pdf->MultiCell(0,18, utf8_encode("$metodos"),0,'J');
//$pdf->Ln(8);
$pdf->SetFont('arial','B',12);
$pdf->MultiCell(0,18, utf8_encode("Resultados:"),0,'J');
$pdf->SetFont('arial','',12);
$pdf->MultiCell(0,18, utf8_encode("$resultados"),0,'J');
//$pdf->Ln(8);
$pdf->SetFont('arial','B',12);
$pdf->MultiCell(0,18, "Conclusão:",0,'J');
$pdf->SetFont('arial','',12);
$pdf->MultiCell(0,18, utf8_encode("$conclusao"),0,'J');
//$pdf->Ln(8);
$pdf->SetFont('arial','B',12);
...
//$pdf->Ln(8);
$pdf->SetFont('arial','B',12);
$pdf->MultiCell(0,18, utf8_encode("Apoio Financeiro:"),0,'J');
$pdf->SetFont('arial','',12);
$pdf->MultiCell(0,18, utf8_encode("$apoio"),0,'J');
$pdf->SetFont('arial','B',12);
