...
<?
$soc = $row_cpf['sociedade_filiada'];
$sql_sociedades2 = "SELECT * FROM tb_sociedades WHERE id= $soc";
$res_sociedades2 = mysqlexecuta($id,$sql_sociedades2);
$row_sociedades2=mysql_fetch_array($res_sociedades2);
//if($row_cpf['sociedade_filiada']==$row_sociedades['id']){
            echo "<option value=".$row_sociedades2['id'].">".utf8_encode($row_sociedades2['nome'])."</option>";
//}

$sql_sociedades = "SELECT * FROM tb_sociedades";
$res_sociedades = mysqlexecuta($id,$sql_sociedades);

//    echo "<option value='23'>".'Sociedade Filiada'."</option><br />";
    while($row_sociedades=mysql_fetch_array($res_sociedades)){


        //echo "<option value='14'>"."1"."</option>";
        echo "<option value='".$row_sociedades['id']."'>".utf8_encode($row_sociedades['nome'])."</option>";
    }
?>
        </select>
      </div>
