...
$sql8 = "SELECT * FROM `tb_sessao` WHERE id>4 ORDER BY id ASC";
...
echo "<table><tr><td><p align='center'><b>".$row8['nome']." - ".$data_inicio." - ".$row8['hora_inicio']."-".$row8['hora_fim']."</b></p></td></tr></table>";
...
<table>
   <tr>
	...
	<td width=70%><center><font size=20><b><? echo $area_id.".".$painel ?></b></font></center></td>
    <td><img src="https://chart.googleapis.com/chart?chs=120x120&border=0&cht=qr&chl=http://fmsys.com.br/fmsys/fesbe/fesbe2019/user/exibe_trabalho.php?id_trabalho=<? echo $id_trabalho; ?>"></td>
    </tr>
    </table>
    <?
...
/**
echo utf8_decode("<p><b>Introdução:</b></p>");	
echo "<p>".$row['introducao']."</p>";
echo utf8_decode("<p><b>Objetivos:</b></p>");	
echo "<p>".$row['objetivos']."</p>";
echo utf8_decode("<p><b>Métodos:</b></p>");	
echo "<p>".utf8_decode($comite_etica)."  ".$row['metodos']."</p>";
echo "<p><b>Resultados:</b></p>";	
echo "<p>".$row['resultados']."</p>";
echo utf8_decode("<p><b>Conclusão:</b></p>");	
echo "<p>".$row['conclusao']."</p>";
