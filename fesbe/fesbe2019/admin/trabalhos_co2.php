...
$sql30 = "SELECT * FROM `tb_trabalhos` WHERE `area_id`=$area AND `status`=4 AND (co ='' or co is NULL) ORDER BY `painel` ASC";
...
echo     "<h3 class='ls-collapse-title'><center>ID ".$id_trabalho."   -   ".$area.".".$painel."  "."<br />".utf8_encode($row30['titulo'])."</center></h3></a><div class='ls-collapse-body' id='$id_trabalho'>";
