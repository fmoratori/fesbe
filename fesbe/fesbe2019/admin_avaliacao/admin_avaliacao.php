           ...
           <li>
            ...
            <a href="./admin_avaliacao.php?pg=consulta_trabalhos.php" class="ls-ico-pencil" title="Trabalhos">Trabalhos</a>
                ...
                <ul>
                    ...
                    <li><a href="./admin_avaliacao.php?pg=consulta_trabalhos_avaliacao.php" title="Trabalhos Para Avaliacao"> Trabalhos Para Avaliação</a></li>
                    ...
                    <li><a href="./admin_avaliacao.php?pg=avaliacao_painel.php" title="Painel"> Painel de Avaliação</a></li>
                    <!--li><a href="./admin_avaliacao.php?pg=home2.php" title="Painel"> Lançar Avaliação</a></li--->
