...
$sql = "INSERT INTO `tb_propostas_conf` SET `nome_prop`='$nome',`doc_prop`='$doc_proponente',`cargo_prop`='$cargo',`email_prop`='$email',`tel_prop`='$telefone', `cel_prop`='$celular', `inst_prop`='$inst',`sociedade_prop`='$soc_proponente',`titulo_conf`='$titulo',`prof_aula1`='$nome_conf',`doc_aula1`='$doc_conf',`email_aula1`='$email_conf',`inst_aula1`='$inst_conf',`depto_aula1`='$depto_conf',`end_aula1`='$end',`cep_aula1`='$codigo_postal',`pais_aula1`='$pais',`tel_aula1`='$tel',`cel_aula1`='$cel',`midia`='$midia', `justificativa`='$justif',`valida`='$valida',`updated_on`='$date';";
