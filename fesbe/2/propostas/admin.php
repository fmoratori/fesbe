...
if($pg!=''){
    ...
    $count_conf = mysql_query("SELECT COUNT(*) FROM `tb_propostas_conf`");
	$conf =  mysql_result($count_conf, 0);

    $count_simp = mysql_query("SELECT COUNT(*) FROM `tb_propostas_simp`");
	$simp =  mysql_result($count_simp, 0);
    
    $count_mt = mysql_query("SELECT COUNT(*) FROM `tb_propostas_mt`");
...
?><br /><br />
<div class="ls-box"><a href="http://fmsys.com.br/fmsys/fesbe/2/propostas/admin.php?pg=lista_conf.php" target="_blank">Propostas Conferência <div align='right'><? echo $conf; ?></div></a></div>
<div class="ls-box"><a href="http://fmsys.com.br/fmsys/fesbe/2/propostas/admin.php?pg=lista_simp.php" target="_blank">Propostas Simpósio <div align='right'><? echo $simp; ?></div></a></div>
<div class="ls-box"><a href="http://fmsys.com.br/fmsys/fesbe/2/propostas/admin.php?pg=lista_mt1.php" target="_blank">Propostas Módulo Temático<div align='right'><? echo $mt; ?></div></a></div>
<div class="ls-box"><a href="http://fmsys.com.br/fmsys/fesbe/2/propostas/admin.php?pg=lista_curso.php" target="_blank">Propostas Curso<div align='right'><? echo $curso; ?></div></a></div>
