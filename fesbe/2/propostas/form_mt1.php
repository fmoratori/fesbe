...
<form id="form1" action="./propostas.php?pg=envia_mt1.php" name="f1" class="ls-form ls-form-horizontal row" data-ls-module="form" method="POST">
...
<label class="ls-label col-md-3">
    ...
    <input type="text" name="cargo_prop" class="" required="required" value="<? echo $row_cpf['cargo']; ?>" > 
  </label>
<label class="ls-label col-md-3">
...
<label class="ls-label col-md-4">
    ...
    <input type="text" name="soc_prop" class="" required="required" value="<? echo $row_cpf['sociedade_prop']; ?>" > 
  </label>  
</fieldset>
</div>
