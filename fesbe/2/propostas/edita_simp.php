...
$valida = $_GET['valida'];
$sql = "SELECT * FROM `tb_propostas_simp` where valida LIKE '$valida'";
...
<label class="ls-label col-md-4">
    <b class="ls-label-text">Sociedade(s) de Filia&ccedil;&atilde;o do Proponente</b>
     <input type="text" name="inst" class="" required="required" value="<? echo $row['sociedade_prop']; ?>" > 
  </label>  
</fieldset>
</div>
...
<label class="ls-label col-md-6">
    ...
    <input type="text" name="titulo_geral" class="" required="required" value="<? echo $row['titulo_curso']; ?>" > 
  </label>
</fieldset>
<br />
<br />
...
<label class="ls-label col-md-4">
    ...
    <input type="text" name="nome_conf_1" id="ttxtttt2" class="" value="<? echo $row['prof_aula1']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-3">
    ...
    <input type="text" name="doc_conf_1" id="ttxtttt4" class="" placeholder="" value="<? echo $row['doc_aula1']; ?>" > 
  </label>
<label class="ls-label col-md-3">
    <b class="ls-label-text" id="ttxtttt5">E-mail</b>
    <input type="email" name="email_conf_1" id="ttxtttt6" class="" value="<? echo $row['email_aula1']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="ttxtttt7">Telefone</b>
    <input type="text" name="tel_1" id="ttxtttt8" class="ls-mask-phone8_with_ddd" placeholder="(00)0000-0000" value="<? echo $row['tel_aula1']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text"id="ttxtttt9">Celular</b>
    <input type="text" name="cel_1" id="ttxtttt10" class="ls-mask-phone9_with_ddd" placeholder="(00)90000-0000" value="<? echo $row['cel_aula1']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-5">
    ...
    <input type="text" name="depto_conf_1" id="ttxtttt12" class="" value="<? echo $row['depto_aula1']; ?>" > 
  </label>
<label class="ls-label col-md-5">
    <b class="ls-label-text" id="ttxtttt13">Institui&ccedil;&atilde;o</b>
    <input type="text" name="inst_conf_1" id="ttxtttt14" class="" value="<? echo $row['inst_aula1']; ?>" > 
  </label> 
</fieldset>
<br />
<!--
...
<label class="ls-label col-md-4">
    ...
    <input type="text" id="tttxtttt2" name="nome_conf_2" class="" value="<? echo $row['prof_aula2']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-3">
    ...
    <input type="text" name="doc_conf_2" id="tttxtttt4" class="" placeholder="" value="<? echo $row['doc_aula2']; ?>" > 
  </label>
<label class="ls-label col-md-3">
    <b class="ls-label-text" id="tttxtttt5">E-mail</b>
    <input type="email" name="email_conf_2" id="tttxtttt6" class="" value="<? echo $row['email_aula2']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="tttxtttt7" >Telefone</b>
    <input type="text" name="tel_2" id="tttxtttt8" class="ls-mask-phone8_with_ddd" placeholder="(00)0000-0000" value="<? echo $row['tel_aula2']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="tttxtttt9">Celular</b>
    <input type="text" name="cel_2" id="tttxtttt10" class="ls-mask-phone9_with_ddd" placeholder="(00)90000-0000" value="<? echo $row['cel_aula2']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-5">
    ...
    <input type="text" name="depto_conf_2" id="tttxtttt12" class="" value="<? echo $row['depto_aula2']; ?>" > 
  </label>
<label class="ls-label col-md-5">
    <b class="ls-label-text" id="tttxtttt13">Institui&ccedil;&atilde;o</b>
    <input type="text" name="inst_conf_2" id="tttxtttt14" class="" value="<? echo $row['inst_aula2']; ?>" > 
  </label> 
</fieldset>
<br />
<!---
...
<label class="ls-label col-md-6">
    <b class="ls-label-text">T&iacute;tulo</b>
    <input type="text" name="titulo_3" class="" required="required" value="<? echo $row['titulo_aula3']; ?>" > 
  </label>
</fieldset>
<br />
...
<label class="ls-label col-md-4">
    ...
    <input type="text" name="nome_conf_3" id="ttttxtttt2" class="" value="<? echo $row['prof_aula3']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-3">
    ...
    <input type="text" name="doc_conf_3" id="ttttxtttt4" class="" placeholder="" value="<? echo $row['doc_aula3']; ?>" > 
  </label>
<label class="ls-label col-md-3">
    <b class="ls-label-text" id="ttttxtttt5">E-mail</b>
    <input type="email" id="ttttxtttt6" name="email_conf_3" class="" value="<? echo $row['email_aula3']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="ttttxtttt7">Telefone</b>
    <input type="text" name="tel_3" id="ttttxtttt8" class="ls-mask-phone8_with_ddd" placeholder="(00)0000-0000" value="<? echo $row['tel_aula3']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="ttttxtttt9">Celular</b>
    <input type="text" name="cel_3" id="ttttxtttt10" class="ls-mask-phone9_with_ddd" placeholder="(00)90000-0000" value="<? echo $row['cel_aula3']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-5">
    ...
    <input type="text" name="depto_conf_3" id="ttttxtttt12" class="" value="<? echo $row['cargo_aula3']; ?>" > 
  </label>
<label class="ls-label col-md-5">
    <b class="ls-label-text" id="ttttxtttt13">Institui&ccedil;&atilde;o</b>
    <input type="text" name="inst_conf_3" id="ttttxtttt14" class="" value="<? echo $row['inst_aula3']; ?>" > 
  </label> 
</fieldset>
<br />
<!---
...
<label class="ls-label col-md-6">
    <b class="ls-label-text">T&iacute;tulo</b>
    <input type="text" name="titulo_4" class="" required="required" value="<? echo $row['titulo_aula4']; ?>" > 
  </label>
</fieldset>
<br />
...
<label class="ls-label col-md-4">
    ...
    <input type="text" name="nome_conf_4" id="tttttxtttt2" class="" value="<? echo $row['prof_aula4']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-3">
    ...
    <input type="text" name="doc_conf_4" id="tttttxtttt4" class="" placeholder="" value="<? echo $row['doc_aula4']; ?>" > 
  </label>
<label class="ls-label col-md-3">
    <b class="ls-label-text" id="tttttxtttt5">E-mail</b>
    <input type="email" name="email_conf_4" id="tttttxtttt6" class="" value="<? echo $row['email_aula4']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="tttttxtttt7">Telefone</b>
    <input type="text" name="tel_4" id="tttttxtttt8" class="ls-mask-phone8_with_ddd" placeholder="(00)0000-0000" value="<? echo $row['tel_aula4']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text" id="tttttxtttt9">Celular</b>
    <input type="text" name="cel_4" id="tttttxtttt10" class="ls-mask-phone9_with_ddd" placeholder="(00)90000-0000" value="<? echo $row['cel_aula4']; ?>" > 
  </label>
</fieldset>
<br />
<fieldset>
<label class="ls-label col-md-5">
    ...
    <input type="text" name="depto_conf_4" id="tttttxtttt12" class="" value="<? echo $row['depto_aula4']; ?>" > 
  </label>
<label class="ls-label col-md-5">
    <b class="ls-label-text" id="tttttxtttt13">Institui&ccedil;&atilde;o</b>
    <input type="text" name="inst_conf_4" id="tttttxtttt14" class="" value="<? echo $row['inst_aula4']; ?>" > 
  </label> 
</fieldset>
<br />
<!---
...
<label class="ls-label col-md-5">
    ...
    <input type="text" name="end_4" class="" id="tttttxtttt1" required="required" value="<? echo $row['end_aula4']; ?>" > 
  </label>
<label class="ls-label col-md-2">
    <b class="ls-label-text">C&oacute;digo Postal</b>
