...
<?
	...
	$sql10 = "SELECT * FROM tb_areas WHERE id<25 ORDER BY id ASC";
	...
	echo "<tr><td>$z</td><td colspan='2'><u><a href='./trabalhos_exibe.php?id_area=$z' target='_blank' style='color:blue'>".utf8_encode($row10['nome_area'])."</td></a></u></tr>";
