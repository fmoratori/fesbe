           ...
           <li>
            <a href="./principal_admin.php?pg=consulta_inscritos.php" class="ls-ico-user" title="Inscritos">Inscritos</a>
                <ul>
                    ...
                    <li><a href="./principal_admin.php?pg=analise.php" title="Valida Categorias"> Valida Categorias </a></li>
                    <li><a href="./principal_admin.php?pg=exportar_inscritos.php" title="Exportar Inscritos"> Exportar Inscritos </a></li>
                </ul>
           </li>
           <li>
