                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="login.php?ver=s" autocomplete="on" method="POST"> 
                                <h1>Log in</h1> 
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > CPF (somente n&uacute;meros) ou E-mail </label>
                                ...
                                <p>GERAR OU VALIDAR CERTIFICADO ?<a href="http://fmsys.com.br/fmsys/fesbe/2/user/register.php?pg=certificados_cpf.php" class="to_register">Clique Aqui</a></p>
                                <p>Esqueceu sua senha ?<a href="./register.php?pg=form_recuperar_senha.php" class="to_register">Clique Aqui</a></p>
                                <p class="change_link">
									Ainda n&atilde;o se inscreveu ?
									<a href="./register.php?pg=form1.php" class="to_register">Inscreva-se</a>
								</p>
                            </form>
                        </div>
