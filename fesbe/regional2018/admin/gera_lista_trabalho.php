...
//	$area=$row10['id'];
 //   $tem_trabalho=0;
    $area = 26;
$sql30 = "SELECT * FROM `tb_trabalhos` WHERE `area_id`=$area AND `status`=3 ORDER BY `id` ASC";
$res30 = mysqlexecuta($id,$sql30);
$y=0;
    echo "<br /><h2><center><b>PROVOC</b></center></h2><br />";

while($row30 = mysql_fetch_array($res30)){
$y++;
//if($tem_trabalho==0){
//    echo "<br /><br /><h2><center><b>CAP</b></center></h2><br /><br />";
