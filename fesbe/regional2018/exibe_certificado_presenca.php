...
$texto = "Certificamos que ".$titulo_exibe." participou da ".$row_evento['nome_evento'].", realizado de ".$inicio." a ".$fim." na cidade de ".$row_evento['local'].".";
...
//	$pdf->Cell(0,0,utf8_decode("São Paulo, 09 de setembro de 2015."),0,250,'C');
	...
	$pdf->Cell(0,18, utf8_decode("Codigo de Autenticação: ".$autenticacao),0,'J');
	$pdf->Image("./rodape.jpg",0,530,840,50);
  //  ob_start();
 //  $pdf->Output($autenticacao.".pdf","F");
