...
if($caracteres>3550){
     echo "<meta http-equiv='refresh' content=0;url='http://fmsys.com.br/fmsys/fesbe/regional2018/user/principal.php?pg=trabalhos.php&id_trabalho=$id_trabalho&caracteres=$caracteres&idioma=$idioma'>";
    break;
}
