...
$sql1 = "SELECT * FROM `tb_propostas_curso_2018` ORDER BY `id`";
...
$pdf->MultiCell(0,16, $row1['titulo_curso']." ",0,'C');
...
$pdf->SetFont('arial','B',13);
$pdf->MultiCell(0,25, "Título: ".$row1['titulo_curso'],0,'J');
$pdf->SetFont('arial','B',13);
...
$pdf->Output("./arquivos/curso/proposta_cursos".$hora.".pdf","F");
$filename = "./arquivos/curso/proposta_cursos".$hora.".pdf";
?>
