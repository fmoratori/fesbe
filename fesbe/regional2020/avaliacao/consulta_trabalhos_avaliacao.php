...
if($ver==1){
    ...
    $sql_consulta_trabalhos = "SELECT * FROM tb_trabalhos WHERE `usuario_id` IN (SELECT user_id FROM tb_boleto WHERE `situacao` = 'PG' OR `situacao` = 'IS') $complemento AND `status`=3 AND `avaliador_id`=0 ORDER BY `id` ASC";
