...
$mensagemHTML = "O trabalho <b>".$row56['titulo']."</b> foi aprovado pela Comiss&atilde;o de Avalia&ccedil;&atilde;o".$quebra_linha."<br /><br />Atenciosamente,<br />Comiss&atilde;o Organizadora <br />".utf8_decode($row_evento['nome_evento']);
$mail = new PHPMailer();
$mail = new PHPMailer();
...
$mensagemHTML = "O trabalho <b>".$row56['titulo']."</b> Recebeu o seguinte parecer:<br /><br />".$parecer2. "<br />Acesse sua &aacute;rea restrita e realize as altera&ccedil;&otilde;es necess&aacute;rias em at&eacute; 2 dias. ".$quebra_linha."<br /><br />Atenciosamente,<br />Comiss&atilde;o Organizadora <br />".utf8_decode($row_evento['nome_evento']);
...
$mensagemHTML = "O trabalho <b>".$row56['titulo']."</b> Foi Recusado. Segue abaixo o motivo da recusa:<br /><br />".$parecer2. "<br />".$quebra_linha."<br /><br />Atenciosamente,<br />Comiss&atilde;o Organizadora <br />".utf8_decode($row_evento['nome_evento']);
$mail = new PHPMailer();
$mail->IsSMTP();
$mail->SMTPAuth = true;
$mail->SMTPSecure = "ssl";
