...
$res = mysqlexecuta($id,$sql);
 ...
 ?>
                            <meta http-equiv="refresh" content="0; url=./admin_avaliacao.php?val=<? echo $val; ?>">
...
<html class="ls-theme-green-lemon">
  ...
  <img src="../imagens/header.jpg" width="100%" height="30%" /><br />
...
<div class="ls-login-box">
  ...
  <form role="form" class="ls-form ls-login-form" action="login_admin.php?ver=s" method="POST">
    <fieldset>
