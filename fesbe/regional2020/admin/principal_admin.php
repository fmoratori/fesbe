           ...
           <li>
            ...
            <a href="./principal_admin.php?pg=consulta_trabalhos.php" class="ls-ico-pencil" title="Trabalhos">Trabalhos</a>
                ...
                <ul>
                    ...
                    <li><a href="./lista_mencao.php" target="_blank" title="Lista Menção"> Lista Menção Honrosa</a></li>
                    ...
                    <li><a href="./arquivos_resumos_sessao.php" target="_blank" title="Resumos Por Sessao"> Todos Trabalhos (Íntegra Sessão)</a></li>
