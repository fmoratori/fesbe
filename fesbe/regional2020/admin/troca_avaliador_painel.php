...
if($ver==1){
$sql_muda_avaliador = "UPDATE `tb_trabalhos` SET `avaliador_painel`='$novo_avaliador' WHERE `id`=$id_trabalho;";
...
//  echo $texto;
  ?>
 <form action="troca_avaliador_painel.php?ver=1&fonte=2&id_trabalho=<? echo $id_trabalho; ?>" class="ls-form row" method="POST" target="_blank">
