...
<!--      <a href="/locawebstyle/documentacao/exemplos//pre-painel"  class="ls-go-prev"><span class="ls-text">Voltar à lista de serviços</span></a>--->
      ...
      <nav class="ls-menu">
        ...
        <ul>
           ...
           <li><a href="./principal_admin_painel.php?pg=home.php" class="ls-ico-home" title="Home">Home</a></li>

           <li>

           <a href="./principal_admin_painel.php?pg=painel.php" class="ls-ico-pencil" title="Apar&eecirc;ncia">Evento</a>

            <ul>

                <li><a href="./principal_admin_painel.php?pg=painel_admin.php" title="Painel Admin"> Painel Admin</a></li>

            </ul>
            <ul>

                <li><a href="./principal_admin_painel.php?pg=consulta_trabalhos_avaliacao_painel.php" title="Distribuir Paineis"> Distribuir Paineis</a></li>
