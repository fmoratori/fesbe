...
$texto = "Informamos que seu resumo intitulado: ".utf8_encode($titulo).", autores ".utf8_encode($autores).", foi aceito para apresentação na forma de painel na ".$row['nome_evento'].", que ocorrerá de  25 a 27 de maio de 2020 na Universidade Federal de Goiás, em Goiânia - Goiás.";
$evento = $row['sigla'];
