...
<html class="ls-theme-orange">
  ...
  <img src="../imagens/header.jpg" width="100%" height="50%" />
...
<div class="ls-login-box">
  <h1 class="ls-login-logo">J&aacute; estou inscrito</h1>
  ...
  <form role="form" class="ls-form ls-login-form" action="login.php?ver=s" method="POST">
    <fieldset>
      ...
      <label class="ls-label">
        ...
        <input class="ls-login-bg-user ls-field-lg" id="username" name="login" required="required" type="text" placeholder="E-mail/CPF" required autofocus>
      </label>
...
<div class="ls-login-box">
  <h1 class="ls-login-logo">Nova Inscri&ccedil;&atilde;o</h1>
  ...
  <form role="form" class="ls-form ls-login-form" action="register.php?pg=form2.php&idioma=1" method="POST">
    <fieldset>
      ...
      <label class="ls-label">
        ...
        <input class="ls-login-bg-user ls-field-lg" id="cpf" name="cpf" required="required" type="text" placeholder="CPF" required autofocus>
        <!--h2><center>Evento Encerrado</center></h2-->
      </label>
        ...
        <div class="ls-prefix-group ls-field-lg">
            ...
            <label class="ls-label">
        <b class="ls-label-text ls-hidden-accessible"></b>
                      <input type="submit" value="Registrar" class="ls-btn-primary ls-btn-block ls-btn-lg">
        <div class="ls-prefix-group ls-field-lg">
        </div>
      </label>
...
<div class="ls-login-box">
  <h1 class="ls-login-logo">Iniciar Sesi�n</h1>
  ...
  <form role="form" class="ls-form ls-login-form" action="login.php?ver=s" method="POST">
    <fieldset>
      ...
      <p><a class="ls-login-forgot" href="./register.php?pg=form_recuperar_senha.php">�Has olvidado la contrase�a?</a></p>

      <input type="submit" value="Iniciar Sesi�n" class="ls-btn-primary ls-btn-block ls-btn-lg">
      <!--p class="ls-txt-center ls-login-signup">N&atilde;o realizou seu cadastro ainda? <a href="./register.php?pg=form1.php&idioma=2">Cadastre-se agora</a></p-->
<p>&nbsp;</p>
    </fieldset>
  </form>
