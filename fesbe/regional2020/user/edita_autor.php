...
<form action="./principal.php?pg=armazena_edita_autor.php&id_trabalho=<? echo $id_trabalho; ?>&id_autor=<? echo $id_autor; ?>" class="ls-form ls-form-horizontal" method="POST">
