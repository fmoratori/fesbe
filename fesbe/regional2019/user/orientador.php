...
<br />
<!--div class="ls-alert-warning"><h3>Preencha os dados do <strong>Orientador</strong> do seu trabalho que será responsável pela validação do mesmo.</h3></div-->
...
<a href="./principal.php?pg=autores.php&id_trabalho=<? echo $id_trabalho; ?>" class="ls-btn-dark ls-ico-chevron-right">Próximo</a>
...
<h1 class="ls-title-intro ls-ico-pencil2">Advisor</h1>
<div data-ls-module="progressBar" role="progressbar" aria-valuenow="<? echo number_format(((100/6)*1),2); ?>" class="ls-animated"></div>
<br />
<!--div class="ls-alert-warning"><h3>Preencha os dados do <strong>Orientador</strong> do seu trabalho que será responsável pela validação do mesmo.</h3></div--->
<div class="ls-box-filter">
<form action="./principal.php?pg=armazena_orientador.php&id_trabalho=<? echo $id_trabalho; ?>&idioma=2" class="ls-form ls-form-horizontal" method="POST">
    <label class="ls-label col-md-4">
...
if($x>0){
?>
<a href="./principal.php?pg=instituicoes.php&id_trabalho=<? echo $id_trabalho; ?>&idioma=2" class="ls-btn-dark ls-ico-chevron-left">Anterior</a>
<a href="./principal.php?pg=autores.php&id_trabalho=<? echo $id_trabalho; ?>&idioma=2" class="ls-btn-dark ls-ico-chevron-right">Próximo</a>
...
<h1 class="ls-title-intro ls-ico-pencil2">Tutor</h1>
<div data-ls-module="progressBar" role="progressbar" aria-valuenow="<? echo number_format(((100/6)*1),2); ?>" class="ls-animated"></div>
<br />
<!--div class="ls-alert-warning"><h3>Preencha os dados do <strong>Orientador</strong> do seu trabalho que será responsável pela validação do mesmo.</h3></div--->
<div class="ls-box-filter">
...
if($x>0){
?>
<a href="./principal.php?pg=instituicoes.php&id_trabalho=<? echo $id_trabalho; ?>&idioma=3" class="ls-btn-dark ls-ico-chevron-left">Anterior</a>
<a href="./principal.php?pg=autores.php&id_trabalho=<? echo $id_trabalho; ?>&idioma=3" class="ls-btn-dark ls-ico-chevron-right">Próximo</a>
