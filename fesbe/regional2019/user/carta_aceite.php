...
$texto = "Informamos que seu resumo intitulado: ".utf8_encode($titulo).", autores ".utf8_encode($autores).", foi aceito para apresentação na forma de painel na ".$row['nome_evento'].", que ocorrerá de  29 a 31 de maio de 2019 no Campus do Guamá, em Belém - Pará.";
$evento = $row['sigla'];
