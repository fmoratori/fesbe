...
$cpf_post = $_GET['id'];
//$cpf_post = 120;
	$sql222 = "SELECT * FROM tb_avaliador_sbnec WHERE id = $cpf_post";
...
$validacao =  "https://eventoexpress.com.br/sig/sbnec/sis/avaliacao/index.asp";

$mensagemHTML = "Prezado(a) $nome,<br />
<br  />
Existe 1 ou mais trabalhos na sua &aacute;rea reservada aguardando uma nova avalia&ccedil;&atilde;o (Alterado).
<br />
Considerando o prazo restrito para avalia&ccedil;&atilde;o dos trabalhos, solicitamos que finalize a avalia&ccedil;&atilde;o o mais r&aacute;pido poss&iacute;vel e n&atilde;o solicitem novas corre&ccedil;&atilde;es.<br />
<br />
<br />
Acesse: o link <a href='https://eventoexpress.com.br/sig/sbnec/sis/avaliacao/index.asp'> https://eventoexpress.com.br/sig/sbnec/sis/avaliacao/index.asp</a>
<br />
<br /><br />

Usuario <b>$email</b> e senha <b>$senha</b><br /><br />
Desde ja agradecemos seu apoio e colaboracao.<br />
<br />
...
$mail->Username = "sbnec@cwyeventos.com.br";

$mail->Password = "14sbnec17";

$mail->From = "sbnec@cwyeventos.com.br";

$mail->FromName = "SBNeC";

$mail->Subject = 'Trabalho Aguardando Avaliacao '."SBNeC";
...
$mail->AddAddress('sbnec@cwyeventos.com.br', $row_evento['sigla']);
