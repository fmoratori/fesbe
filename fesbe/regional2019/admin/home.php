...
<?
	...
	echo "<tr><td colspan='2'>".$z.". ".utf8_encode($row10['nome_area'])."</td><td>".$area."</td>"."</tr>";
...
<?
	...
	$sql101 = "SELECT DISTINCT estado,COUNT(*) AS quantidade FROM tb_usuario WHERE id IN (SELECT usuario_id FROM tb_trabalhos) GROUP BY estado ORDER BY quantidade DESC";
