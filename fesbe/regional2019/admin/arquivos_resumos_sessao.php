...
<p>
   ...
   <!--tr-->
	...
	<!--td--><? echo "<b>".$area_id.".".$painel."</b> - <span class='uppercase'>".trim($titulo)."</span>. ".trim($autores)." - " ?>
...
if($row['comite'] != ""){
$comite_etica = $row['comite'];
}
if($row['ceh'] != ""){
$comite_etica = $row['ceh'];
}
if($row['cea'] != ""){
$comite_etica = $row['cea'];
}
if($row['justifique'] != ""){
$comite_etica = $row['justifique'];
}
$area_painel = $row['area_id'];
if($area_painel<10){
...
echo "<p><b>Introdu&ccedil;&atilde;o:</b></p>";	
echo "<p>".$row['introducao']."</p>";
echo "<p><b>Objetivos:</b></p>";	
echo "<p>".$row['objetivos']."</p>";
echo "<p><b>M&eacute;todos:</b></p>";	
echo "<p>".$row['metodos']."</p>";
echo "<p><b>Resultados:</b></p>";	
echo "<p>".$row['resultados']."</p>";
echo "<p><b>Conclus&atilde;o:</b></p>";	
echo "<p>".$row['conclusao']."</p>";
if($row30['premio']==6){
echo "<p><b>Comit&ecirc; de &Eacute;tica:</b></p>";
echo "<p>".$comite_etica."</p>";
}
