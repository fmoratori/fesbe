...
<div class="ls-box-filter">
  ...
  <form action="principal_admin_painel.php?pg=consulta_trabalhos_avaliacao_painel.php&ver=1" class="ls-form ls-form-inline row" method="POST">
 <fieldset>
...
if($ver==1){
    ...
    $sql_consulta_trabalhos = "SELECT * FROM tb_trabalhos WHERE `usuario_id` $complemento AND `status`=4 AND `avaliador_painel`=0 ORDER BY `painel` ASC";
