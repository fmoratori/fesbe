...
$senha = $row222['senha']; 
$nome = $row222['nome'];
	$sql2222 = "SELECT * FROM tb_trabalhos WHERE avaliador_painel = $cpf_post AND sessao_id=3 ORDER BY area_id";
	$res2222 = mysqlexecuta($id,$sql2222);
    while($row2222 = mysql_fetch_array($res2222)){
        $area = $row2222['area_id'];
        $painel = $row2222['painel'];
        $titulo = $row2222['titulo'];
        $trabalhos = $trabalhos."<b>".$area.".".$painel." - ".$titulo."</b><br /><br />";
    }
...
$validacao =  "http://fmsys.com.br/fmsys/regional2019/avaliacao/login.php";

$mensagemHTML = "Prezado(a) $nome,<br />
<br />

Contamos com a sua colaboração para a avaliação dos trabalhos do dia <b>31 de Maio</b>, durante a XIII Reunião Regional da FeSBE - Belém - PA.
<br />
Acesse este link no dia da sua Avaliação: <a href='http://fmsys.com.br/fmsys/fesbe/regional2019/painel/'> http://fmsys.com.br/fmsys/fesbe/regional2019/painel/</a>
<br />
<br />
Usuario <b>$email</b> e senha <b>$senha</b><br />
<br />
Trabalhos para avalia&ccedil;&atilde;o:<br />
<br />
$trabalhos
<br />
Qualquer dúvida, estamos a disposição no e-mail fesbe@fesbe.org.br, ou na mesa de avaliação próximo aos painéis.<br />
<br />
Atenciosamente,<br />
<br />
...
$mail->Subject = 'Avaliacao de Paineis '.$row['nome_evento'];
...
<meta http-equiv="refresh" content="0; url=/fmsys/fesbe/regional2019/admin/principal_admin.php?pg=avaliacao.php">
<?
}
?>