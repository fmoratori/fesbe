...
$nome_conf_4 = $_POST['nome_conf_4'];
$doc_conf_4 = $_POST['doc_conf_4'];
$email_conf_4 = $_POST['email_conf_4'];
$inst_conf_4 = $_POST['inst_conf_4'];
$depto_conf_4 = $_POST['depto_conf_4'];
$end_4 = $_POST['end_4'];
$codigo_postal_4 = $_POST['codigo_postal_4'];
$pais_4 = $_POST['pais_4'];
$tel_4 = $_POST['tel_4'];
$cel_4 = $_POST['cel_4'];
...
if($_POST['igual_prop5']!='dif'){
$nome_conf_4 = $nome;
$doc_conf_4 = $doc_proponente;
$email_conf_4 = $email;
$inst_conf_4 = $inst;
$depto_conf_4 = $departamento;
$tel_4 = $telefone;
$cel_4 = $celular;
}
$sql = "INSERT INTO `tb_propostas_simp_2018` SET `nome_prop`='$nome',`doc_prop`='$doc_proponente',`cargo_prop`='$cargo',`email_prop`='$email',`tel_prop`='$telefone',`cel_prop`='$celular',`inst_prop` = '$inst', `sociedade_prop`='$soc_proponente',`nome_coord`='$nome_coord',`doc_coord`='$doc_coord',`email_coord`='$email_coord',`inst_coord`='$inst_coord',`depto_coord`='$depto_coord',`end_coord`='$end_coord',`cep_coord`='$codigo_postal_coord',`pais_coord`='$pais_coord',`tel_coord`='$tel_coord',`cel_coord`='$cel_coord',`titulo_curso`='$titulo_geral',`titulo_aula1`='$titulo_1',`prof_aula1`='$nome_conf_1',`doc_aula1`='$doc_conf_1',`email_aula1`='$email_conf_1',`inst_aula1`='$inst_conf_1',`depto_aula1`='$depto_conf_1',`end_aula1`='$end_1',`cep_aula1`='$codigo_postal_1',`pais_aula1`='$pais_1',`tel_aula1`='$tel_1',`cel_aula1`='$cel_1',`titulo_aula2`='$titulo_2',`prof_aula2`='$nome_conf_2',`doc_aula2`='$doc_conf_2',`email_aula2`='$email_conf_2',`inst_aula2`='$inst_conf_2',`depto_aula2`='$depto_conf_2',`end_aula2`='$end_2',`cep_aula2`='$codigo_postal_2',`pais_aula2`='$pais_2',`tel_aula2`='$tel_2',`cel_aula2`='$cel_2',`titulo_aula3`='$titulo_3',`prof_aula3`='$nome_conf_3',`doc_aula3`='$doc_conf_3',`email_aula3`='$email_conf_3',`inst_aula3`='$inst_conf_3',`depto_aula3`='$depto_conf_3',`end_aula3`='$end_3',`cep_aula3`='$codigo_postal_3',`pais_aula3`='$pais_3',`tel_aula3`='$tel_3',`cel_aula3`='$cel_3', `titulo_aula4`='$titulo_4',`prof_aula4`='$nome_conf_4',`doc_aula4`='$doc_conf_4',`email_aula4`='$email_conf_4',`inst_aula4`='$inst_conf_4',`depto_aula4`='$depto_conf_4',`end_aula4`='$end_4',`cep_aula4`='$codigo_postal_4',`pais_aula4`='$pais_4',`tel_aula4`='$tel_4',`cel_aula4`='$cel_4', `justificativa`='$justif',`valida`='$valida',`updated_on`='$date';";
...
<b>Aula 4</b><br />
Título: $titulo_4 <br />
Professor:	$nome_conf_4 <br />
Documento: $doc_conf_4 <br />
E-mail: $email_conf_4 <br />
Instituição: $inst_conf_4 <br />
Depto:	$depto_conf_4 <br />
Telefone:	$tel_4 <br />
Celular:	$cel_4 <br />
